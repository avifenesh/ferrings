...
pub struct ServerOptions {
    ...
    pub tcp_defer_accept_seconds: Option<u32>,
    ...
    pub zcrx_rx_buffer_size: Option<u32>,
}
...
pub struct TcpServerOptions {
    ...
    pub use_recv_bundle: Option<bool>,
    pub use_zero_copy_send: Option<bool>,
    pub send_buffer_count: Option<u32>,
...
pub struct ServerInfo {
    ...
    pub command_queue_drops: u32,
    pub event_queue_capacity: u32,
    pub event_queue_drops: u32,
    ...
    pub provided_buffer_ring: bool,
    pub recv_bundle: bool,
    pub recv_bundle_completions: u32,
    pub recv_bundle_buffers: u32,
    pub recv_bundle_bytes: u32,
    pub recv_buffer_starvations: u32,
    pub recv_multishot_resubmits: u32,
    pub recv_copy_events: u32,
    pub recv_copy_bytes: u32,
    pub registered_send_buffer: bool,
    pub registered_send_requests: u32,
    pub registered_send_errors: u32,
    pub fixed_send_buffer_misses: u32,
    pub fixed_send_buffer_miss_bytes: u32,
    pub zero_copy_send: bool,
    pub zero_copy_send_requests: u32,
    pub zero_copy_send_notifications: u32,
    pub zero_copy_send_copied: u32,
    pub zero_copy_send_errors: u32,
    pub zero_copy_receive: bool,
    pub zcrx_ready: bool,
    pub zcrx_rx_buffer_size: u32,
    pub zcrx_packets: u32,
    pub zcrx_bytes: u32,
}
